    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Recording Server</li>
            </ol>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Recording Server
                    <a href="addServidorG.php"><button type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nuevo recording server</button></a>
                </div>
                <div class="card-body">
