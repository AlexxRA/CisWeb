    ...
    <ul class="sidebar navbar-nav">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item active" href="showServidorG.php">Recording Server</a>
            </div>
        </li>
        <li class="nav-item">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-register mx-auto">
                <div class="card-header">Registrar nuevo servidor</div>
                <div class="card-body">
                    <form action="addServidorG.php" method="post" name="formUser">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-label-group">
                                        <input type="text" id="ubicacion" name="ubicacion" class="form-control" placeholder="Ubicacion" required autofocus="autofocus">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        <input type="text" id="ip_servidorg" name="ip_servidorg" class="form-control" placeholder="IP" required  onkeypress="return validarnum(event)">
