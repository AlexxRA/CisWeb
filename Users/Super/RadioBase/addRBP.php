<?php
    if(isset($_POST['input'])) {
        ...
        $RB = new RadioBase($dist_rb, $rss_rb, $ip_rb, $mac_rb, $id_sitio, $sector, $id_vlan);
        $Connector->insert("radiobase", $RB->getSQL(),"(dist_rb, rss_rb, ip_rb, mac_rb, sector, id_sitio, id_vlan)");
