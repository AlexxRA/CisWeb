        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Switch
                    <a href="addSwitch.php"><button type="button" class="btn btn-outline-secondary ml-auto mr-0 mr-md-3 my-2 my-md-0" title="Agregar nuevo">Agregar nuevo switch</button></a>
                </div>
                <div class="card-body">
