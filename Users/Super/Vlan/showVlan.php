...
if(isset($_GET['action']) == 'delete'){
    ...
    $c= new Connector();
    $conn=$c->getCon();
    $query = mysqli_query($conn, "SELECT * FROM vlan WHERE id_vlan='$id_delete'");
    if(mysqli_num_rows($query) == 0){
        ...
        $delete = mysqli_query($conn, "DELETE FROM vlan WHERE id_vlan='$id_delete'");
        if($delete){
            mysqli_commit($conn);
...
if (isset($_GET["e"])){
    ...
    if($error==1){
        ...
        <script type="text/javascript">
            history.pushState(null, "", "showVlan.php");
        </script>
    <?php
    }
    elseif($error==2){
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Municipios
                    <a href="addVlan.php"><button type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nueva VLAN</button></a>
                </div>
                <div class="card-body">
