...
if(isset($_GET['action']) == 'delete'){
    ...
    if(mysqli_num_rows($query) == 0){
        ...
        if($delete){
            $deleteCom = mysqli_query($conn, "DELETE FROM comentarios WHERE identificador='$id_delete' and tabla='boton'");
            if($deleteCom){
                mysqli_commit($conn);
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Botones
                    <a href="addBoton.php"><button type="button" class="btn btn-outline-secondary ml-auto mr-0 my-2 my-md-0 float-right" title="Agregar nuevo">Agregar nuevo botón</button></a>
                </div>
                <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function formatearSalidaDeDatosComplementarios (filaDelDataSet ) {
            ...
            cadenaDeRetorno+='<a href="../Busqueda/search.php?id_pmi='+filaDelDataSet[4]+'"  title="Ir a la información del PMI" class="btn" type="button"> Informacion de PMI</a>';
