...
<body id="page-top">
<?php session_start(); include ("../../../SGBD/Connector.php"); include("updateSuscriptorP.php");
                    ...
                    <form action="updateSuscriptor.php" method="post" name="formCamera" id="formCamera">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-label-group">
                                        <input type="text" id="ns_sus" name="ns_sus" class="form-control" placeholder="Numero de Serie" required value="<?php echo $row['ns_sus']; ?>" readonly="readonly">
