<?php
    class Camera {
        ...
        public function __construct($ns_cam, $ip_cam, $mac_cam, $tipo, $num_cam, $ori_cam, $inc_cam, $nom_cam, $rec_server, $id_device, $firmware, $vms, $user_cam, $pass_cam, $fecha_inst, $id_pmi)
        {
            $this->ns_cam = $ns_cam;
            $this->ip_cam = $ip_cam;
        ...
        public function getSQL(){
            return "'".$this->ns_cam."','".$this->ip_cam."','".$this->mac_cam."','".$this->tipo."','".$this->num_cam."','".$this->ori_cam."','".$this->inc_cam."','".$this->nom_cam."','".$this->rec_server."','".$this->id_device."','".$this->firmware."','".$this->vms."','".$this->user_cam."','".$this->pass_cam."','".$this->fecha_inst."','".$this->id_pmi."'";
        }

        public function UpdateSQL(){
            return "ns_cam='$this->ns_cam', ip_cam='$this->ip_cam', mac_cam='$this->mac_cam', tipo='$this->tipo', num_cam='$this->num_cam', ori_cam='$this->ori_cam', inc_cam='$this->inc_cam', nom_cam='$this->nom_cam', rec_server='$this->rec_server', firmware='$this->firmware', vms='$this->vms', user_cam='$this->user_cam', pass_cam='$this->pass_cam', fecha_inst='$this->fecha_inst', id_pmi='$this->id_pmi'";
        }
